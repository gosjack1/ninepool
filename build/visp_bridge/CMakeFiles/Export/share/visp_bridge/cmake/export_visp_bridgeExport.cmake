...
foreach(_expectedTarget visp_bridge::visp_bridge)
...
# Create imported target visp_bridge::visp_bridge
add_library(visp_bridge::visp_bridge SHARED IMPORTED)

set_target_properties(visp_bridge::visp_bridge PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/visp_bridge;/opt/ros/humble/include;/usr/include/opencv4;/usr/include/eigen3;/usr/include/x86_64-linux-gnu;/usr/include"
...
file(GLOB CONFIG_FILES "${_DIR}/export_visp_bridgeExport-*.cmake")
